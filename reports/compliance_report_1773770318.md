...
**Generated:** 2026-03-17T17:58:38Z  
**Mode:** LIVE MODE  
**Report ID:** 1773770318
...
|--------|-------|
| **Networks Checked** | 1 |
| **Networks Compliant** | 1 ✅ |
| **Networks Non-Compliant** | 0 ⚠️ |
...
0 2 * * * cd /path/to/repo && ansible-playbook -i inventory/production.yml playbooks/compliance_check.yml
```
