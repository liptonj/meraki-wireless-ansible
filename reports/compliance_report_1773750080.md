...
**Generated:** 2026-03-17T12:21:20Z  
**Mode:** LIVE MODE  
**Report ID:** 1773750080
...
| **SSIDs Compliant** | 15 ✅ |
| **SSIDs Non-Compliant** | 0 ⚠️ |
| **Group Policies Checked** | 1 |
| **Group Policies Non-Compliant** | 1 ⚠️ |
...
| **Corp-Guest** | 1 | ✅ PASS | ✅ True | ✅ psk | ✅ wpa | ✅ WPA2 only | ✅ True | ✅ False | ✅ 11 | ✅ Dual band operation |
| **Unconfigured SSID 3** | 2 | ✅ PASS | ✅ False | ✅ open | ✅ unknown | ✅  | ✅ True | ✅ False | ✅ 11 | ✅ Dual band operation |
...
|--------------|----|-------------------|----------|----------|--------|
| **Lab-Site1 Restricted Policy** | 100 | custom | 3 | 0 | ⚠️ FAIL |

#### ⚠️ Group Policy ACL Findings

**Group Policy: Lab-Site1 Restricted Policy (100)**

| Severity | Message | Current | Expected |
|----------|---------|---------|----------|
| CRITICAL | Group policy "Lab-Site1 Restricted Policy" L3 rule action changed — Deny RFC1918 east-west traffic to 192.168/16 | `allow any to 192.168.0.0/16:any` | `deny any to 192.168.0.0/16:any` |
